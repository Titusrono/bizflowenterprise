...
import { InventoryService, Inventory, InventoryStats } from '../service/inventory.service';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, InventoryListComponent, InventoryFormComponent],
